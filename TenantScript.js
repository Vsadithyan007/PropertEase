  ...
  if(regnum=="" || nameV=="" || addressV=="" || mailV=="" || mobV=="" || pswd1V=="" || pswd2V=="")
  {
    ...
    if(pswd1V != pswd2V){
      ...
      .then(function(userCredential) {
        ...
        firebase.database().ref("Tenant/" + regnum).set({ Reg_No: regnum, name: nameV, gender: genderV, address: addressV, mail: mailV, mob: mobV, password: pswd1V,State: stateV,City: cityV, DOB: dobV, Status: "not approved", Wallet_addr: ""});
  alert("Data Inserted");
...
document.getElementById("update").onclick = function () {
  ...
  firebase
    .database().ref("student/" + regnum).update({ Status: "Approved",
      Wallet_addr: genderV,
      address: addressV,
    });
  alert("Approved");
